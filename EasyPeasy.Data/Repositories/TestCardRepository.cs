...
public class TestCardRepository : BaseRepository<TestCardEntity, EasyPeasyDbContext>, ITestCardRepository
{
    public TestCardRepository(IDbContextFactory<EasyPeasyDbContext> contextFactory, IUserContext? userContext = null)
