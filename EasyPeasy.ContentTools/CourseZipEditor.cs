...
/// produced by <c>EasyPeasy.App/Services/CourseZipBackupService.cs</c>), without touching the
...
{
    /// <summary>
    /// Must match <c>EasyPeasy.App/Services/CourseZipBackupService.JsonOpts</c> exactly, or the
    ...
    // CoursePackageManifest (course.json's C# model) lives in EasyPeasy.App, which this
