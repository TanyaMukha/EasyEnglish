...
/// <summary>
/// Shared base for EasyPeasy.Business tests: opens one SQLite in-memory connection per test class
/// instance, builds the real <see cref="EasyPeasyDbContext"/> schema against it, and wires up all
