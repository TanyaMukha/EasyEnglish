...
using ReviewWordCard = EasyPeasy.App.Components.Pages.Drilling.Cards.ReviewWordsCard;
using SingleChoiceCard = EasyPeasy.App.Components.Pages.Drilling.Cards.SingleChoiceWordCard;
using ManualInputCard = EasyPeasy.App.Components.Pages.Drilling.Cards.ManualInputWordCard;
using ReviewIrregularFormsCard = EasyPeasy.App.Components.Pages.Drilling.Cards.ReviewIrregularFormsCard;
using InputIrregularFormsCard = EasyPeasy.App.Components.Pages.Drilling.Cards.InputIrregularFormsCard;
using StudyIrregularFormsCard = EasyPeasy.App.Components.Pages.Drilling.Cards.StudyIrregularFormsCard;
