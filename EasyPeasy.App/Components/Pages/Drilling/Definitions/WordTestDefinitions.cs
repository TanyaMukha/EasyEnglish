...
using KnowOrNotCard    = EasyPeasy.App.Components.Pages.Drilling.Cards.KnowOrNotWordCard;
using ManualInputCard  = EasyPeasy.App.Components.Pages.Drilling.Cards.ManualInputWordCard;
using StudyWordCard    = EasyPeasy.App.Components.Pages.Drilling.Cards.StudyWordCard;
