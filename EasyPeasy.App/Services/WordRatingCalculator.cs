...
/// (difficulty on the <c>[0, 5]</c> scale — see <c>EasyPeasy.Core.Extensions.RateExtensions</c> for
...
public static class WordRatingCalculator
{
    ...
    // little to matter. See EasyPeasy.App/Services/README.md for the tuning history in git blame.
    ...
    /// update in the batch (see EasyPeasy.App/Services/README.md Known Issues #1, now fixed).
    /// </summary>
