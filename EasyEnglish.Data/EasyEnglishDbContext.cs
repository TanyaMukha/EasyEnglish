...
/// <summary>
/// EF Core context for the EasyEnglish SQLite database. Schema is defined entirely through data
/// annotations on the <c>EasyEnglish.Core.Entities.*</c> classes (<c>[Table]</c>, <c>[Column]</c>,
...
/// current schema/entity-relationship diagrams see <c>EasyEnglish.Docs/Diagrams/database.mdpuml</c>
