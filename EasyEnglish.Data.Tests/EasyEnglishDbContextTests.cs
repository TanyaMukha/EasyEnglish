...
/// <summary>Tests for <see cref="EasyEnglishDbContext.SaveChangesAsync"/>'s automatic <c>CreatedAt</c>/<c>UpdatedAt</c> stamping.</summary>
public class EasyEnglishDbContextTests : SqliteTestBase
{
    [Fact]
